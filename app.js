...
async function connectToDatabase() {
    ...
    const result = await connection.query("select * from brby_customers.core_data limit 10");
...
async function queryExample() {
    ...
    const result = await pool.query('select * from brby_customers.core_data limit 10');
    return result;
}
